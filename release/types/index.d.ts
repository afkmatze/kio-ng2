...
export declare const primitiveNodeType: (name: string | number) => Types.KioPrimitiveContentType;
export declare const childNodeType: (name: string | number) => Types.KioChildContentType;
